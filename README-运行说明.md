...
- `backend/`：独立 Node 后端服务
  - `server.js`：承接 `/api/report`、`/api/product-sets`、`/api/taobao`
...
```bash
cd /Users/shuishoukeke/Desktop/电商竞品分析项目-前后端源码-20260721-135110/backend
npm run dev
```
...
- 前端开发服务会把 `/api/report`、`/api/product-sets`、`/api/taobao` 代理到 `backend`。
