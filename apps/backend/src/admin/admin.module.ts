...
@Module({
  ...
  controllers: [UserController, RoleController, PermissionController, TenantController, DepartmentController, StoreController, PlatformController, ProviderProfileController],
