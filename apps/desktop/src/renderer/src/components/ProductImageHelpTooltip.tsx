...
import productHelpExample1 from '../assets/product-help-example-1.png'
import productHelpExample2 from '../assets/product-help-example-2.png'
import productHelpExample3 from '../assets/product-help-example-3.png'
import productHelpExample4 from '../assets/product-help-example-4.png'
import productHelpExample5 from '../assets/product-help-example-5.png'
import productHelpExample6 from '../assets/product-help-example-6.png'

// 商品原图上传引导（对照旧版 ProductImageHelpTooltip，逐字还原文案 + 对错示例图）
  ...
  return (
    <span className="group/help relative inline-flex">
      ...
      <span className="pointer-events-auto absolute left-4 top-0 z-50 hidden w-[244px] rounded-[10px] bg-white p-4 text-left text-[12px] font-normal leading-[18px] text-[#171A1D] opacity-0 shadow-[0_16px_40px_rgba(15,23,41,.18)] group-hover/help:block group-hover/help:opacity-100 group-focus-within/help:block group-focus-within/help:opacity-100">
        <span className="mb-3 block">1.可上传同一商品的多视角原图，帮助AI更准确还原商品细节。</span>
        <span className="mb-3 block">2.最多支持 6 张图片，第一张将作为主图重点参考，建议选择角度最全的一张。</span>
